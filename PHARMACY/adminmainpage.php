...
<body>
	...
	<div class="sidenav">
			<h2 style="font-family:Arial; color:white; text-align:center;"> MIRIAM PHARMACY</h2>
...
<!-- 
			...
			<div class="dropdown-container">
				<a href="employee-add.php">Add New Users</a>
				<a href="employee-view.php">Manage Users</a>
			</div>
	...
	<img src="carticon1.png" style="padding:8px;margin-left:40px;margin-top:40px;width:200px;height:200px;border:2px solid black;" alt="Add New Sale">
	</a>
